...
public class A_TryCatch {
	 ...
	 *   } catch(Exception e){
	 *   	//try블록에서 예외가 발생 시 실행을 멈추고 catch 블록을 실행
	 *   } finally {
	 *   	//생략이 가능하며 예외가 발생하거나 예외가 발생하지 않았을 경우 모두 실행한다
	 *   	//보통 자원을 반납하는 문장이 작성
	 *   }
	 * @throws Exception 
	 */
	...
	public void method1() {
		//오류가 발생할 소지가 있는 메서드를 try-catch문으로 감싸 오류처리를 할 수 있다
